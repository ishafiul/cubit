...
var _ usecase.DeploymentRepository = (*DeploymentRepo)(nil)

// DeploymentRepo implements usecase.DeploymentRepository using SQLite.
...
func (r *DeploymentRepo) Save(ctx context.Context, dep *domain.Deployment) error {
...
func (r *DeploymentRepo) Update(ctx context.Context, dep *domain.Deployment) error {
	var finishedAtStr sql.NullString
	if dep.FinishedAt != nil {
		finishedAtStr.String = dep.FinishedAt.Format(time.RFC3339)
		finishedAtStr.Valid = true
...
func (r *DeploymentRepo) AppendLog(ctx context.Context, deploymentID string, entry domain.DeploymentLog) error {
	query := `
...
func (r *DeploymentRepo) GetLogs(ctx context.Context, deploymentID string) ([]domain.DeploymentLog, error) {
	query := `
