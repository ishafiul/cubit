...
func NewServicesRepo(database *sql.DB, baseDir string) *ServicesRepo {
	if baseDir == "" {
		baseDir = ".data"
	}
...
func (r *ServicesRepo) SaveKVNamespace(ctx context.Context, ns *domain.KVNamespace) error {
...
func (r *ServicesRepo) ListKVNamespaces(ctx context.Context) ([]*domain.KVNamespace, error) {
	query := `
...
func (r *ServicesRepo) GetKVNamespace(ctx context.Context, id string) (*domain.KVNamespace, error) {
	query := `
		SELECT n.id, n.name, n.created_at, COUNT(e.key) as key_count
		FROM kv_namespaces n
		LEFT JOIN kv_entries e ON n.id = e.namespace_id
...
func (r *ServicesRepo) DeleteKVNamespace(ctx context.Context, id string) error {
	query := `DELETE FROM kv_namespaces WHERE id = ?`
	_, err := r.db.ExecContext(ctx, query, id)
	return err
}

func (r *ServicesRepo) PutKVPair(ctx context.Context, pair *domain.KVPair) error {
	query := `
...
func (r *ServicesRepo) GetKVPair(ctx context.Context, namespaceID, key string) (*domain.KVPair, error) {
...
func (r *ServicesRepo) ListKVPairs(ctx context.Context, namespaceID string) ([]*domain.KVPair, error) {
...
func (r *ServicesRepo) DeleteKVPair(ctx context.Context, namespaceID, key string) error {
...
func (r *ServicesRepo) SaveD1Database(ctx context.Context, d1 *domain.D1Database) error {
...
func (r *ServicesRepo) ListD1Databases(ctx context.Context) ([]*domain.D1Database, error) {
...
func (r *ServicesRepo) GetD1Database(ctx context.Context, id string) (*domain.D1Database, error) {
...
func (r *ServicesRepo) DeleteD1Database(ctx context.Context, id string) error {
...
func (r *ServicesRepo) ExecuteD1Query(ctx context.Context, id, queryStr string) (*domain.D1QueryResult, error) {
	dbPath := filepath.Join(r.baseDir, "d1", fmt.Sprintf("%s.db", id))
	subDB, err := sql.Open("sqlite", dbPath)
	if err != nil {
...
func (r *ServicesRepo) SaveQueue(ctx context.Context, q *domain.Queue) error {
...
func (r *ServicesRepo) ListQueues(ctx context.Context) ([]*domain.Queue, error) {
	query := `
...
func (r *ServicesRepo) DeleteQueue(ctx context.Context, id string) error {
	query := `DELETE FROM queues WHERE id = ?`
	_, err := r.db.ExecContext(ctx, query, id)
	return err
}

func (r *ServicesRepo) EnqueueMessage(ctx context.Context, msg *domain.QueueMessage) error {
...
func (r *ServicesRepo) ListQueueMessages(ctx context.Context, queueID string, limit int) ([]*domain.QueueMessage, error) {
	if limit <= 0 {
		limit = 50
	}
...
func (r *ServicesRepo) SaveCronTrigger(ctx context.Context, c *domain.CronTrigger) error {
...
func (r *ServicesRepo) ListCronTriggers(ctx context.Context) ([]*domain.CronTrigger, error) {
...
func (r *ServicesRepo) DeleteCronTrigger(ctx context.Context, id string) error {
	query := `DELETE FROM cron_triggers WHERE id = ?`
	_, err := r.db.ExecContext(ctx, query, id)
	return err
}

func (r *ServicesRepo) RecordCronRun(ctx context.Context, run *domain.CronRun) error {
...
func (r *ServicesRepo) ListCronRuns(ctx context.Context, triggerID string) ([]*domain.CronRun, error) {
...
func (r *ServicesRepo) SaveWorkflow(ctx context.Context, wf *domain.Workflow) error {
...
func (r *ServicesRepo) ListWorkflows(ctx context.Context) ([]*domain.Workflow, error) {
...
func (r *ServicesRepo) DeleteWorkflow(ctx context.Context, id string) error {
	query := `DELETE FROM workflows WHERE id = ?`
	_, err := r.db.ExecContext(ctx, query, id)
	return err
}

func (r *ServicesRepo) SaveWorkflowRun(ctx context.Context, run *domain.WorkflowRun) error {
...
func (r *ServicesRepo) ListWorkflowRuns(ctx context.Context, workflowID string) ([]*domain.WorkflowRun, error) {
...
func (r *ServicesRepo) SaveDurableObjectClass(ctx context.Context, doc *domain.DurableObjectClass) error {
...
func (r *ServicesRepo) ListDurableObjectClasses(ctx context.Context) ([]*domain.DurableObjectClass, error) {
	query := `
...
func (r *ServicesRepo) DeleteDurableObjectClass(ctx context.Context, id string) error {
	query := `DELETE FROM durable_objects WHERE id = ?`
	_, err := r.db.ExecContext(ctx, query, id)
	return err
}

func (r *ServicesRepo) SaveDOInstance(ctx context.Context, inst *domain.DurableObjectInstance) error {
...
func (r *ServicesRepo) ListDOInstances(ctx context.Context, classID string) ([]*domain.DurableObjectInstance, error) {
...
func (r *ServicesRepo) SaveContainer(ctx context.Context, ct *domain.ContainerWorkload) error {
...
func (r *ServicesRepo) ListContainers(ctx context.Context) ([]*domain.ContainerWorkload, error) {
...
func (r *ServicesRepo) DeleteContainer(ctx context.Context, id string) error {
...
func (r *ServicesRepo) SaveStaticSite(ctx context.Context, site *domain.StaticSite) error {
	spaRouting := 0
	if site.SPARouting {
		spaRouting = 1
	}
...
func (r *ServicesRepo) ListStaticSites(ctx context.Context) ([]*domain.StaticSite, error) {
...
func (r *ServicesRepo) DeleteStaticSite(ctx context.Context, id string) error {
